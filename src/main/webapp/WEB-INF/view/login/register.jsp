...
<div class="loginWraper">
  ...
  <div id="tipsDiv" style="height:30px;visibility:hidden;"><span id="tipsSpan" style="padding-left:200px;font-size:20px;color:red;">用户名或者密码出错！</span></div>
    <form class="form form-horizontal" id="loginForm">
      <div class="row cl">
        <label class="form-label col-xs-3">
        	<i class="Hui-iconfont">用户名</i>
        </label>
      ...
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">确认密码</i></label>
        <div class="formControls col-xs-8">
          <input id="password_again" name="" type="password" placeholder="确认密码" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
...
<div class="footer">Copyright By Zqs</div>
</body>
</html>